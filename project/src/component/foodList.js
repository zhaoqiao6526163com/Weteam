...
class FoodList extends Component{
  ...
  render(){
    let {updateData,data,count,pageSize,nowpage} = this.state
    return(
        <div className='tabel-container'>
          {this.state.changeModel?<Model nowpage={nowpage} update={updateData} refresh={this.refreshData} cancel={this.cancelModel}></Model>:''}
